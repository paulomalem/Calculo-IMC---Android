...
public class SobrePesoActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtResultado = (TextView) findViewById(R.id.txtResultadoAcima);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("SIM", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        Intent i = new Intent(SobrePesoActivity.this, MainActivity.class);
        ...
        if (v == buttonCalculaNova) {
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("SIM", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface arg0, int arg1) {
                            repositorioImc.excluirUltimo();
                            new Intent(SobrePesoActivity.this, CalculoImcActivity.class);
                            finish();
                        }
                    })
                    .setNegativeButton("Não", new DialogInterface.OnClickListener() {
