...
public class PesoAbaixoActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_peso_abaixo);

        txtResultado = (TextView) findViewById(R.id.txtResultadoBaixo);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("SIM", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        Intent i = new Intent(PesoAbaixoActivity.this, MainActivity.class);
        ...
        if (v == buttonCalculaNova) {
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("SIM", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface arg0, int arg1) {
                            repositorioImc.excluirUltimo();
                            new Intent(PesoAbaixoActivity.this, CalculoImcActivity.class);
                            finish();
                        }
                    })
                    .setNegativeButton("Não", new DialogInterface.OnClickListener() {
