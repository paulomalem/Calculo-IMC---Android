...
public class Obesidade1Activity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtResultado = (TextView) findViewById(R.id.txtResultadoObesidade1);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("SIM", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        Intent i = new Intent(Obesidade1Activity.this, MainActivity.class);
