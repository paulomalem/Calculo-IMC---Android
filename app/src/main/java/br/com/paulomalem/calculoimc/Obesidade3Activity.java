...
public class Obesidade3Activity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtResultado = (TextView) findViewById(R.id.txtResultadoObesidade3);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("SIM", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        Intent i = new Intent(Obesidade3Activity.this, MainActivity.class);
        ...
        if (v == buttonCalculaNova) {
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("SIM", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface arg0, int arg1) {
                            repositorioImc.excluirUltimo();
                            new Intent(Obesidade3Activity.this, CalculoImcActivity.class);
                            finish();
                        }
                    })
                    .setNegativeButton("Não", new DialogInterface.OnClickListener() {
